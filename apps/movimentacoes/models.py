...
class Movimentacao(models.Model):
    ...
    anexo = models.FileField(verbose_name='Upload de Anexos', upload_to='anexos', blank=True, null=True)
    ...
    data_ateracao = models.DateTimeField(verbose_name='Data Alteração', auto_now=True)
